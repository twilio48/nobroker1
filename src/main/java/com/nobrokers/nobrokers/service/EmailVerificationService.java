...
public class EmailVerificationService {
    ...
    public Map<String, String> verifyOtp(String email, String otp) {
        //otp that got store in storedOtp before you sending an email,here email is a key name
    ...
    public Map<String, String> sendOtpForLogin(String email) {
        //firstly checking whether user is registered or not
        if (userService.isEmailVerified(email)) {
            String otp = emailService.generateOtp();
            //store that Otp on temporary basis in hashmap
